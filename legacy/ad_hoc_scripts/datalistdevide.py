...
if __name__ == '__main__':
    file_path = r"C:\Users\CQU-996\Desktop\data\JPEGImages"  # 图片文件夹
    label_path = r'C:\Users\CQU-996\Desktop\data\labels'  # 标签文件夹
    new_file_path = r"C:\Users\CQU-996\Desktop\data\VOCdevkit"  # 新数据存放位置
